...
# Radiohead - Creep (Modular/Compositional Style)
#
...
defmodule CreepDemo do
  ...
  defp build_melody(opts \\ []) do
    ...
    [
      {0.0, [s: "superpiano", n: 67, gain: gain]},
      {0.25, [s: "superpiano", n: 71, gain: gain * 0.8]},
      {1.0, [s: "superpiano", n: 71, gain: gain]},
      {1.25, [s: "superpiano", n: 75, gain: gain * 0.8]},
      {2.0, [s: "superpiano", n: 72, gain: gain]},
      {2.25, [s: "superpiano", n: 76, gain: gain * 0.8]},
      {3.0, [s: "superpiano", n: 72, gain: gain]},
      {3.25, [s: "superpiano", n: 75, gain: gain * 0.8]}
    ]
  end
  ...
  defp print_info do
    ...
    🎸 Radiohead - Creep (Modular Style)
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    Playing at #{@bpm} BPM

    Available functions:
      CreepDemo.play()        # Standard version
      CreepDemo.play_quiet()  # Quiet/verse dynamics
      CreepDemo.play_loud()   # Loud/chorus dynamics
