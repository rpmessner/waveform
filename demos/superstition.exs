...
#
# Demonstrates the famous funky groove with syncopated rhythms
# and the iconic clavinet-style riff.
#
# Usage:
#   mix run demos/superstition.exs

defmodule SuperstitionDemo do
  ...
  defp build_funk_riff(opts \\ []) do
    ...
    [
      # Bar 1
      {0.0, [s: "superpiano", n: 63, gain: gain, speed: 1.5]},      # Eb4
      {0.0625, [s: "superpiano", n: 63, gain: gain * 0.7, speed: 1.5]},
      {0.1875, [s: "superpiano", n: 66, gain: gain, speed: 1.5]},   # F#4
      {0.25, [s: "superpiano", n: 63, gain: gain, speed: 1.5]},     # Eb4
      {0.4375, [s: "superpiano", n: 58, gain: gain, speed: 1.5]},   # Bb3
      {0.5, [s: "superpiano", n: 63, gain: gain, speed: 1.5]},      # Eb4

      # Bar 2
      {1.0, [s: "superpiano", n: 63, gain: gain, speed: 1.5]},      # Eb4
      {1.0625, [s: "superpiano", n: 63, gain: gain * 0.7, speed: 1.5]},
      {1.1875, [s: "superpiano", n: 66, gain: gain, speed: 1.5]},   # F#4
      {1.25, [s: "superpiano", n: 63, gain: gain, speed: 1.5]},     # Eb4
      {1.4375, [s: "superpiano", n: 58, gain: gain, speed: 1.5]},   # Bb3
      {1.5, [s: "superpiano", n: 61, gain: gain, speed: 1.5]}       # Db4
    ]
  end
  ...
  defp build_bass(opts \\ []) do
    ...
    [
      {0.0, [s: "bass", n: 39, gain: gain]},       # Eb2
      {0.1875, [s: "bass", n: 39, gain: gain * 0.6]},
      {0.375, [s: "bass", n: 42, gain: gain * 0.8]}, # F#2
      {0.5, [s: "bass", n: 39, gain: gain]},       # Eb2
      {0.75, [s: "bass", n: 46, gain: gain * 0.7]}, # Bb2

      {1.0, [s: "bass", n: 39, gain: gain]},       # Eb2
      {1.1875, [s: "bass", n: 39, gain: gain * 0.6]},
      {1.375, [s: "bass", n: 42, gain: gain * 0.8]}, # F#2
      {1.5, [s: "bass", n: 37, gain: gain]},       # Db2
      {1.75, [s: "bass", n: 46, gain: gain * 0.7]}  # Bb2
    ]
  end
